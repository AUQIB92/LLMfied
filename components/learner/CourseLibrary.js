...
export default function CourseLibrary({ onCourseSelect }) {
  ...
  // For demo purposes
  const coursesArray = filteredCourses.length > 0 ? filteredCourses : [
    {
      _id: "course1",
      title: "Machine Learning Fundamentals",
      description: "Master the core concepts of machine learning, from algorithms to implementation",
      category: "Data Science",
      level: "intermediate",
      enrollmentCount: 1245,
      rating: 4.8,
      modules: Array(12).fill({})
    },
    {
      _id: "course2",
      title: "Web Development Bootcamp",
      description: "Comprehensive guide to modern web development with HTML, CSS, and JavaScript",
      category: "Programming",
      level: "beginner",
      enrollmentCount: 3421,
      rating: 4.9,
      modules: Array(15).fill({})
    },
    {
      _id: "course3",
    ...
    },
    {
      ...
      description: "Comprehensive introduction to data analysis and visualization with Python",
      category: "Data Science",
      level: "intermediate",
      enrollmentCount: 2134,
      rating: 4.8,
      modules: Array(14).fill({})
    },
    {
      _id: "course6",
          ...
          <div className="flex justify-center animate-fade-in-up stagger-2">
            <div className="inline-flex items-center gap-8 bg-white/80 backdrop-blur-xl border border-slate-200 rounded-2xl px-8 py-4 shadow-xl">
              <div className="text-center">
                <div className="text-2xl font-bold text-slate-800">{coursesArray.length}</div>
                <div className="text-sm text-slate-600">Published Courses</div>
              </div>
              <div className="w-px h-8 bg-slate-200"></div>
              <div className="text-center">
                <div className="text-2xl font-bold text-slate-800">
                  {coursesArray.reduce((acc, course) => acc + (course.enrollmentCount || 0), 0)}
                </div>
          ...
          {coursesArray.map((course, index) => {
            ...
            return (
              <Card 
                ...
                onClick={() => onCourseSelect({...course, ...randomData})}
              >
                      ...
                      {isEnrolled(course._id) ? (
                        <>
                          <Button 
                            ...
                            onClick={(e) => {
                              e.stopPropagation()
                              onCourseSelect({...course, ...randomData})
                            }}
                          >
